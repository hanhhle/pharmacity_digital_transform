...
?>
          <!-- Cart Icon -->
          <a href="/index.php?route=checkout" class="relative flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white hover:bg-white/20">
            <svg fill="none" viewBox="0 0 24 24" aria-hidden="true" class="inline-block shrink-0 w-5 h-5">
            ...
            <span class="absolute -top-1 -right-1 bg-amber-500 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full"><?= $cartBadgeCount ?></span>
          </a>
